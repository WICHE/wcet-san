...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/src/themekit.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./js/src/accordions.js":
/*!******************************!*\
  !*** ./js/src/accordions.js ***!
  \******************************/
...
var _foundation = __webpack_require__(/*! foundation-sites/js/foundation.accordion */ "./node_modules/foundation-sites/js/foundation.accordion.js");
...
new _foundation.Accordion((0, _jquery2.default)('.accordion'), {
...
var _foundation = __webpack_require__(/*! foundation-sites/js/foundation.tooltip */ "./node_modules/foundation-sites/js/foundation.tooltip.js");
...
// import './foundation-setup';
var $copyText = (0, _jquery2.default)('.has-tip'); /**
                                                    * @file
                                                    *
...
if ($copyText.length) {
  var clipboard = new _clipboard2.default('.has-tip');
  new _foundation.Tooltip($copyText);
...
var _svgInjector = __webpack_require__(/*! svg-injector */ "./node_modules/svg-injector/svg-injector.js");
...
var _foundation = __webpack_require__(/*! foundation-sites/js/foundation.responsiveMenu */ "./node_modules/foundation-sites/js/foundation.responsiveMenu.js");
...
new _foundation.ResponsiveMenu((0, _jquery2.default)('.block-menu.menu--main > ul'));

(0, _jquery2.default)(window).on('changed.zf.mediaquery', function (event, newSize, oldSize) {
  var bpSmall = ['small', 'sm-md'],
      bpDesktop = ['medium', 'large', 'xlarge', 'xxlarge'];

  if (_jquery2.default.inArray(oldSize, bpSmall) >= 0 && _jquery2.default.inArray(newSize, bpDesktop) >= 0) {
    removeClonedNav();
  } else if (_jquery2.default.inArray(oldSize, bpDesktop) >= 0 && _jquery2.default.inArray(newSize, bpSmall) >= 0) {
    cloneNav();
  }
});

var blocksToClone = ['block-utilnavigation', 'block-wcet-search'];

function cloneNav() {
  var $nav = (0, _jquery2.default)('.region-header .menu--main');

  for (var i in blocksToClone) {
    var e = blocksToClone[i];
    (0, _jquery2.default)('#' + e).clone().attr('id', e + '-cloned').prependTo($nav);
  }
}

function removeClonedNav() {
  for (var i in blocksToClone) {
    var block = '#' + blocksToClone[i] + '-cloned';
    if ((0, _jquery2.default)(block).length) {
      (0, _jquery2.default)(block).detach();
    }
  }
}
...
/// Mobile Button
var $mobileMenuButton = (0, _jquery2.default)('.menu-button');
var $mainNav = (0, _jquery2.default)('.menu--main');
var $container = (0, _jquery2.default)('.layout-container');
...
(0, _jquery2.default)('.form-select').select2({
  width: 'auto'
});
...
__webpack_require__(/*! ./skip-link */ "./js/src/skip-link.js");

__webpack_require__(/*! ./inject-svg */ "./js/src/inject-svg.js");

__webpack_require__(/*! ./select */ "./js/src/select.js");

__webpack_require__(/*! ./menus */ "./js/src/menus.js");

__webpack_require__(/*! ./accordions */ "./js/src/accordions.js");

__webpack_require__(/*! ./copy */ "./js/src/copy.js");
...
var _foundationCore = __webpack_require__(/*! ./foundation.core.plugin */ "./node_modules/foundation-sites/js/foundation.core.plugin.js");

var _foundationCore2 = __webpack_require__(/*! ./foundation.core.utils */ "./node_modules/foundation-sites/js/foundation.core.utils.js");
...
var _foundationUtil2 = __webpack_require__(/*! ./foundation.util.nest */ "./node_modules/foundation-sites/js/foundation.util.nest.js");

var _foundationCore = __webpack_require__(/*! ./foundation.core.utils */ "./node_modules/foundation-sites/js/foundation.core.utils.js");

var _foundationCore2 = __webpack_require__(/*! ./foundation.core.plugin */ "./node_modules/foundation-sites/js/foundation.core.plugin.js");
...
var _foundationUtil3 = __webpack_require__(/*! ./foundation.util.box */ "./node_modules/foundation-sites/js/foundation.util.box.js");
...
var _foundationUtil4 = __webpack_require__(/*! ./foundation.util.touch */ "./node_modules/foundation-sites/js/foundation.util.touch.js");
...
var _foundationUtil = __webpack_require__(/*! ./foundation.util.box */ "./node_modules/foundation-sites/js/foundation.util.box.js");
...
var _foundationUtil = __webpack_require__(/*! ./foundation.util.mediaQuery */ "./node_modules/foundation-sites/js/foundation.util.mediaQuery.js");

var _foundationCore = __webpack_require__(/*! ./foundation.core.utils */ "./node_modules/foundation-sites/js/foundation.core.utils.js");

var _foundationCore2 = __webpack_require__(/*! ./foundation.core.plugin */ "./node_modules/foundation-sites/js/foundation.core.plugin.js");

var _foundation = __webpack_require__(/*! ./foundation.dropdownMenu */ "./node_modules/foundation-sites/js/foundation.dropdownMenu.js");

var _foundation2 = __webpack_require__(/*! ./foundation.drilldown */ "./node_modules/foundation-sites/js/foundation.drilldown.js");

var _foundation3 = __webpack_require__(/*! ./foundation.accordionMenu */ "./node_modules/foundation-sites/js/foundation.accordionMenu.js");
...
var _foundationUtil2 = __webpack_require__(/*! ./foundation.util.triggers */ "./node_modules/foundation-sites/js/foundation.util.triggers.js");

var _foundation = __webpack_require__(/*! ./foundation.positionable */ "./node_modules/foundation-sites/js/foundation.positionable.js");
